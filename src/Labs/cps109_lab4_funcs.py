...
# --------------------------------------------------------------
def listexponential(n: int, base: int):
...
# 6) Parsing Floats
# --------------------------------------------------------------
def stringtofloatlist(fltstr: str):
    ...
    # List comprehension is the best
    return [float(x) for x in fltstr.split(',')]


# --------------------------------------------------------------
# 7) Maximum of Each Type
# --------------------------------------------------------------
def maxbytype(items: list):
    ...
    for x in items:
        if isinstance(x, int):
            largest[0] = x if largest[0] < x else largest[0]

        if isinstance(x, float):
            largest[1] = x if largest[1] < x else largest[1]
